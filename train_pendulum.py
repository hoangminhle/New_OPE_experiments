...
parser.add_argument(
    '--num-actions', type=int, default=6, metavar='N', help='discretize action space (default:11)')
...
class Agent():
    ...
    def save_param(self):
        torch.save(self.anet.state_dict(), 'pendulum/ppo_d_anet_params.pkl')
        torch.save(self.cnet.state_dict(), 'pendulum/ppo_d_cnet_params.pkl')
...
def main():
    ...
    for i_ep in range(1000):
        ...
        if running_reward > -200:
            ...
            env.close()
            agent.save_param()
            with open('pendulum/ppo_d_training_records.pkl', 'wb') as f:
    ...
    plt.savefig("pendulum/ppo_d.png")
    plt.show()
